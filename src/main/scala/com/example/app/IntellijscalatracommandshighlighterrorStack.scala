...
import shapeless.contrib.scalaz.SequenceFunctions

import collection.mutable
import scala.tools.nsc.ScalaDoc.Command

trait IntellijscalatracommandshighlighterrorStack extends ScalatraServlet with ScalateSupport with SequenceFunctions {
